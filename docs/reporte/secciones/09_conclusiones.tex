...
\begin{enumerate}
    ...
    \item \textbf{Despliegue en el servidor institucional \texttt{cyad.azc.uam.mx}}. La puesta en producción está prevista para el trimestre siguiente al reporte, con \emph{Gunicorn} + \emph{Nginx} y respaldos periódicos de PostgreSQL.
\end{enumerate}
