...
Los manuales de instalación y de usuario forman parte de este mismo apéndice como subsecciones hermanas: la Subsección~\ref{apx:manual-instalacion} contiene el \emph{Manual de instalación} y la Subsección~\ref{apx:manual-usuario} el \emph{Manual de usuario}. Adicionalmente, la carpeta digital de entrega a la Coordinación de Estudios contiene los siguientes artefactos:

\begin{itemize}
    \item \texttt{reporte\_final.pdf} --- compilación íntegra de este documento, con los manuales integrados como subsecciones de este apéndice; entregable único, sin restricciones.
