...
\subsection{Google Forms en la evaluación diagnóstica como apoyo en las actividades docentes. Caso con estudiantes de la Licenciatura en Turismo \cite{leyva2018google}.}
...
\subsection{La autoevaluación docente de aula: un camino para mejorar la práctica educativa \cite{echeverria2011autoevaluacion}.}
...
\subsection{Sistema para la configuración de formularios y captura de los resultados de la evaluación de Atributos de Egreso en un proceso de mejora continua \cite{Cuautle2022}.}
...
\subsection{Sistema académico de gestión escolar trimestralizado \cite{callisaya2024sistema}.}
...
\subsection{Sistema de Gestión Académica a través del desarrollo 
...
\subsection{Sistema de Gestión Administrativa para la Escuela Secundaria No. 44 "Jorge Luis Borges" \cite{gonzalez2017sistema}.}
