...
\begin{longtable}{p{0.04\textwidth} p{0.34\textwidth} p{0.06\textwidth} p{0.44\textwidth}}
    ...
    \midrule
    10 & Documentación para usuarios & 10 & \textbf{Completo}. Fuentes en \texttt{docs/reporte/manuales/usuario/main.tex} y \texttt{docs/reporte/manuales/instalacion/main.tex}; embebidos como Subsecciones~\ref{apx:manual-instalacion} y \ref{apx:manual-usuario}. \\
    \midrule
...
Los manuales de instalación y de usuario se integran en este mismo documento como parte de este anexo: la Subsección~\ref{apx:manual-instalacion} reproduce el \emph{Manual de instalación} y la Subsección~\ref{apx:manual-usuario} el \emph{Manual de usuario}. Adicionalmente, la carpeta digital de entrega a la Coordinación de Estudios contiene los siguientes artefactos:

\begin{itemize}
    \item \texttt{reporte\_final.pdf} --- compilación íntegra de este documento, con los manuales embebidos como subsecciones de este anexo; entregable único, sin restricciones.
